...
Downloads and combines all tiles for the [Telegeography Submarine Cable Map](https://submarine-cable-map-2026.telegeography.com/) to create a full-resolution image. All maps since 2012 are supported.
...
#### Usage
```shell
docker run --rm -it -v "$PWD:/data" ghcr.io/gabe565/subcablemap-dl --year=2026
```
</details>
...
To download the 2026 map, run
```shell
subcablemap-dl --year=2026
```
When done, the map will be available at `submarine-cable-map-2026.png`.
